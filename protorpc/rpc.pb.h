...
PROTOBUF_NAMESPACE_OPEN
template<> ::blaze::net::RpcMessage* Arena::CreateMaybeMessage<::blaze::net::RpcMessage>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace blaze {
namespace net {
...
class RpcMessage :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:blaze.net.RpcMessage) */ {
 public:
  RpcMessage();
  virtual ~RpcMessage();
  ...
  ::blaze::net::MessageType type() const;
  void set_type(::blaze::net::MessageType value);

  // optional .blaze.net.ErrorCode error = 7;
  bool has_error() const;
  void clear_error();
  static const int kErrorFieldNumber = 7;
  ::blaze::net::ErrorCode error() const;
  void set_error(::blaze::net::ErrorCode value);

  // @@protoc_insertion_point(class_scope:blaze.net.RpcMessage)
 private:
  class HasBitSetters;
...
inline ::blaze::net::MessageType RpcMessage::type() const {
  // @@protoc_insertion_point(field_get:blaze.net.RpcMessage.type)
  return static_cast< ::blaze::net::MessageType >(type_);
}
inline void RpcMessage::set_type(::blaze::net::MessageType value) {
  assert(::blaze::net::MessageType_IsValid(value));
  _has_bits_[0] |= 0x00000020u;
  type_ = value;
  // @@protoc_insertion_point(field_set:blaze.net.RpcMessage.type)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 RpcMessage::id() const {
  // @@protoc_insertion_point(field_get:blaze.net.RpcMessage.id)
  return id_;
}
inline void RpcMessage::set_id(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _has_bits_[0] |= 0x00000010u;
  id_ = value;
  // @@protoc_insertion_point(field_set:blaze.net.RpcMessage.id)
}
...
inline const std::string& RpcMessage::service() const {
  // @@protoc_insertion_point(field_get:blaze.net.RpcMessage.service)
...
inline void RpcMessage::set_service(const std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:blaze.net.RpcMessage.service)
}
inline void RpcMessage::set_service(std::string&& value) {
  _has_bits_[0] |= 0x00000001u;
  service_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:blaze.net.RpcMessage.service)
}
inline void RpcMessage::set_service(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:blaze.net.RpcMessage.service)
}
inline void RpcMessage::set_service(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:blaze.net.RpcMessage.service)
}
inline std::string* RpcMessage::mutable_service() {
  _has_bits_[0] |= 0x00000001u;
  // @@protoc_insertion_point(field_mutable:blaze.net.RpcMessage.service)
...
inline std::string* RpcMessage::release_service() {
  // @@protoc_insertion_point(field_release:blaze.net.RpcMessage.service)
  if (!has_service()) {
    return nullptr;
  }
  _has_bits_[0] &= ~0x00000001u;
...
inline void RpcMessage::set_allocated_service(std::string* service) {
  ...
  // @@protoc_insertion_point(field_set_allocated:blaze.net.RpcMessage.service)
}
...
inline const std::string& RpcMessage::method() const {
  // @@protoc_insertion_point(field_get:blaze.net.RpcMessage.method)
...
inline void RpcMessage::set_method(const std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:blaze.net.RpcMessage.method)
}
inline void RpcMessage::set_method(std::string&& value) {
  _has_bits_[0] |= 0x00000002u;
  method_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:blaze.net.RpcMessage.method)
}
inline void RpcMessage::set_method(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:blaze.net.RpcMessage.method)
}
inline void RpcMessage::set_method(const char* value, size_t size) {
  ...
  method_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:blaze.net.RpcMessage.method)
}
inline std::string* RpcMessage::mutable_method() {
  _has_bits_[0] |= 0x00000002u;
  // @@protoc_insertion_point(field_mutable:blaze.net.RpcMessage.method)
...
inline std::string* RpcMessage::release_method() {
  // @@protoc_insertion_point(field_release:blaze.net.RpcMessage.method)
  if (!has_method()) {
    return nullptr;
  }
  _has_bits_[0] &= ~0x00000002u;
...
inline void RpcMessage::set_allocated_method(std::string* method) {
  ...
  // @@protoc_insertion_point(field_set_allocated:blaze.net.RpcMessage.method)
}
...
inline const std::string& RpcMessage::request() const {
  // @@protoc_insertion_point(field_get:blaze.net.RpcMessage.request)
...
inline void RpcMessage::set_request(const std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:blaze.net.RpcMessage.request)
}
inline void RpcMessage::set_request(std::string&& value) {
  _has_bits_[0] |= 0x00000004u;
  request_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:blaze.net.RpcMessage.request)
}
inline void RpcMessage::set_request(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:blaze.net.RpcMessage.request)
}
inline void RpcMessage::set_request(const void* value, size_t size) {
  ...
  request_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:blaze.net.RpcMessage.request)
}
inline std::string* RpcMessage::mutable_request() {
  _has_bits_[0] |= 0x00000004u;
  // @@protoc_insertion_point(field_mutable:blaze.net.RpcMessage.request)
...
inline std::string* RpcMessage::release_request() {
  // @@protoc_insertion_point(field_release:blaze.net.RpcMessage.request)
  if (!has_request()) {
    return nullptr;
  }
  _has_bits_[0] &= ~0x00000004u;
...
inline void RpcMessage::set_allocated_request(std::string* request) {
  ...
  // @@protoc_insertion_point(field_set_allocated:blaze.net.RpcMessage.request)
}
...
inline const std::string& RpcMessage::response() const {
  // @@protoc_insertion_point(field_get:blaze.net.RpcMessage.response)
...
inline void RpcMessage::set_response(const std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:blaze.net.RpcMessage.response)
}
inline void RpcMessage::set_response(std::string&& value) {
  _has_bits_[0] |= 0x00000008u;
  response_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:blaze.net.RpcMessage.response)
}
inline void RpcMessage::set_response(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:blaze.net.RpcMessage.response)
}
inline void RpcMessage::set_response(const void* value, size_t size) {
  ...
  response_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:blaze.net.RpcMessage.response)
}
inline std::string* RpcMessage::mutable_response() {
  _has_bits_[0] |= 0x00000008u;
  // @@protoc_insertion_point(field_mutable:blaze.net.RpcMessage.response)
...
inline std::string* RpcMessage::release_response() {
  // @@protoc_insertion_point(field_release:blaze.net.RpcMessage.response)
  if (!has_response()) {
    return nullptr;
  }
  _has_bits_[0] &= ~0x00000008u;
...
inline void RpcMessage::set_allocated_response(std::string* response) {
  ...
  // @@protoc_insertion_point(field_set_allocated:blaze.net.RpcMessage.response)
}
...
inline ::blaze::net::ErrorCode RpcMessage::error() const {
  // @@protoc_insertion_point(field_get:blaze.net.RpcMessage.error)
  return static_cast< ::blaze::net::ErrorCode >(error_);
}
inline void RpcMessage::set_error(::blaze::net::ErrorCode value) {
  assert(::blaze::net::ErrorCode_IsValid(value));
  _has_bits_[0] |= 0x00000040u;
  error_ = value;
  // @@protoc_insertion_point(field_set:blaze.net.RpcMessage.error)
}
...
template <> struct is_proto_enum< ::blaze::net::MessageType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::blaze::net::MessageType>() {
  return ::blaze::net::MessageType_descriptor();
}
template <> struct is_proto_enum< ::blaze::net::ErrorCode> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::blaze::net::ErrorCode>() {
  return ::blaze::net::ErrorCode_descriptor();
}
